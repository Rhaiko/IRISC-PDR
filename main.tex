...
\begin{tabular}{| l | l | l | l |}
	\hline
	\textbf{Item} & \textbf{File size} & \textbf{Sample rate} & \textbf{Total storage (4h)} \\\hline\hline
	
	NIR camera		& \,MB & 60\,sec 	& \,GB \\\hline
	Guiding camera	& \,MB & 15\,sec	& \,GB \\\hline
	Sanity camera	& \,MB & On request & - \\\hline
	Sensors			& \,B  & 0.1-1\,sec & \,MB \\\hline\hline
	\textbf{Total:} &	   &			& \,GB \\\hline
...
\begin{tabular}{| l | l | l | l |}
	...
	NIR camera (2x10 pics) & 18 MB & 60\,sec & \,Mbits/sec \\\hline
